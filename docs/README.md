...
- **[COMPLIANCE_SCAN.md](COMPLIANCE_SCAN.md)** – Anforderungen vs. Implementierung
- **[CONFORMITY_CHECK.md](CONFORMITY_CHECK.md)** – Technologie-Audit
...
- **[wiki/start_local.md](wiki/start_local.md)** – Schnellstart Backend + JSP Frontend
...
- ✅ Backend-Komponenten (Services, DAOs, Models, Servlets)
- ✅ JSP Frontend-Komponenten (Login, TestRunner, AdminPanel, etc.)
