...
-- Beispiel 11: Multiple Choice (Struktur von Klassen)
WITH q AS (
  INSERT INTO questions (type, prompt, difficulty, points, meta, category)
...
-- Beispiel 13: Multiple Choice (UML-DiagrammAktivitäten darstellen)
WITH q AS (
  INSERT INTO questions (type, prompt, difficulty, points, meta, category)
...
-- Beispiel 14: Multiple Choice (Use-Case-Diagramm Akteur)
WITH q AS (
  INSERT INTO questions (type, prompt, difficulty, points, meta, category)
...
-- Beispiel 15: Multiple Choice (Beziehung zwischen Klassen)
WITH q AS (
  INSERT INTO questions (type, prompt, difficulty, points, meta, category)
...
-- Beispiel 16: Multiple Choice (UML Startpunkt Aktivitätsdiagramm)
WITH q AS (
  INSERT INTO questions (type, prompt, difficulty, points, meta, category)
...
-- Beispiel 17: Multiple Choice (UML Deployment-Diagramm)
WITH q AS (
  INSERT INTO questions (type, prompt, difficulty, points, meta, category)
...
-- Beispiel 18: Lückentext (Use-Case-Diagramm Interaktion)
WITH q AS (
  INSERT INTO questions (type, prompt, difficulty, points, meta, category)
...
-- Beispiel 19: Lückentext (Klassendiagramm Komponenten)
WITH q AS (
  INSERT INTO questions (type, prompt, difficulty, points, meta, category)
...
-- Beispiel 20: Lückentext (Aktivitätsdiagramm Prozess)
WITH q AS (
  INSERT INTO questions (type, prompt, difficulty, points, meta, category)
...
-- Beispiel 21: Lückentext (Aktivitätsdiagramm Prozess)
WITH q AS (
  INSERT INTO questions (type, prompt, difficulty, points, meta, category)
