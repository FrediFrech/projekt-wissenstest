...
-- ===========================================
-- Ergänzungen aus seeds_max.sql (MC + Lückentext)
-- ===========================================
...
WITH q AS (
  INSERT INTO questions (type, prompt, difficulty, points, meta, category)
  SELECT 'MC', 'Welche Aussage trifft auf ein Use-Case-Diagramm zu?', 2, 3, '{"topic":"uml"}', 'Multiple Choice'
  WHERE NOT EXISTS (
    SELECT 1 FROM questions
    WHERE type = 'MC'
...
WITH q AS (
  INSERT INTO questions (type, prompt, difficulty, points, meta, category)
  SELECT 'CLOZE', 'In UML beschreibt das ___ Diagramm die Abläufe zwischen Objekten.', 1, 3, '{"topic":"uml"}', 'Lückentext'
  WHERE NOT EXISTS (
    SELECT 1 FROM questions
    WHERE type = 'CLOZE'
...
WITH q AS (
  INSERT INTO questions (type, prompt, difficulty, points, meta, category)
  SELECT 'CLOZE', 'Ein ___ Diagramm zeigt den Lebenszyklus eines Objekts mit Zuständen und Übergängen.', 1, 3, '{"topic":"uml"}', 'Lückentext'
  WHERE NOT EXISTS (
    SELECT 1 FROM questions
    WHERE type = 'CLOZE'
...
WITH q AS (
  INSERT INTO questions (type, prompt, difficulty, points, meta, category)
  SELECT 'CLOZE', 'Das UML Klassendiagramm zeigt die ___ zwischen den Klassen.', 1, 3, '{"topic":"uml"}', 'Lückentext'
  WHERE NOT EXISTS (
    SELECT 1 FROM questions
    WHERE type = 'CLOZE'
...
WITH q AS (
  INSERT INTO questions (type, prompt, difficulty, points, meta, category)
  SELECT 'CLOZE', 'Ein Use-Case-Diagramm stellt die Interaktion zwischen dem System und den ___ dar.', 1, 3, '{"topic":"uml"}', 'Lückentext'
  WHERE NOT EXISTS (
    SELECT 1 FROM questions
    WHERE type = 'CLOZE'
...
WITH q AS (
  INSERT INTO questions (type, prompt, difficulty, points, meta, category)
  SELECT 'CLOZE', 'Ein Klassendiagramm besteht unter anderem aus Klassen, Attributen und ___.', 1, 3, '{"topic":"uml"}', 'Lückentext'
  WHERE NOT EXISTS (
    SELECT 1 FROM questions
    WHERE type = 'CLOZE'
...
WITH q AS (
  INSERT INTO questions (type, prompt, difficulty, points, meta, category)
  SELECT 'CLOZE', 'Ein Aktivitätsdiagramm wird verwendet, um den ___ eines Prozesses darzustellen.', 1, 3, '{"topic":"uml"}', 'Lückentext'
  WHERE NOT EXISTS (
    SELECT 1 FROM questions
    WHERE type = 'CLOZE'
...
WITH q AS (
  INSERT INTO questions (type, prompt, difficulty, points, meta, category)
  SELECT 'CLOZE', 'In UML werden Klassen in einem Klassendiagramm durch ___ dargestellt.', 1, 3, '{"topic":"uml"}', 'Lückentext'
  WHERE NOT EXISTS (
    SELECT 1 FROM questions
    WHERE type = 'CLOZE'
...
WITH q AS (
  INSERT INTO questions (type, prompt, difficulty, points, meta, category)
  SELECT 'CLOZE', 'Ein Deployment-Diagramm zeigt die ___ Verteilung eines Softwaresystems.', 1, 3, '{"topic":"uml"}', 'Lückentext'
  WHERE NOT EXISTS (
    SELECT 1 FROM questions
    WHERE type = 'CLOZE'
...
-- ===========================================
-- LÜCKENTEXT FRAGEN Schwer (Lückentext 1 - 8)
-- ===========================================
...
WITH q AS (
  INSERT INTO questions (type, prompt, difficulty, points, meta, category)
  SELECT 'CLOZE', 'Ein Sequenzdiagramm stellt die ___ zwischen mehreren Objekten dar. Die vertikale Achse repräsentiert ___, während die horizontale Achse die ___ darstellt. Die ___ werden durch Pfeile dargestellt.', 3, 5, '{"topic":"sequence-diagrams"}', 'Lückentext'
  WHERE NOT EXISTS (
    SELECT 1 FROM questions
    WHERE type = 'CLOZE'
...
WITH q AS (
  ...
  SELECT 'IMAGE', 'Welche Diagrammart wird in der Abbildung dargestellt?', 1, 2, '{"topic":"uml","image":true}', 'Bild mit Antwort', 'assets/questions/leicht/L-B-1.png'
  WHERE NOT EXISTS (
    SELECT 1 FROM questions
    WHERE type = 'IMAGE'
...
WITH q AS (
  INSERT INTO questions (type, prompt, difficulty, points, meta, category, image_url)
  SELECT 'IMAGE', 'Welcher UML-Diagrammtyp ist in der Abbildung dargestellt?', 1, 2, '{"topic":"uml","image":true}', 'Bild mit Antwort', 'assets/questions/leicht/L-B-2.png'
  WHERE NOT EXISTS (
    SELECT 1 FROM questions
    WHERE type = 'IMAGE'
...
WITH q AS (
  INSERT INTO questions (type, prompt, difficulty, points, meta, category, image_url)
  SELECT 'IMAGE', 'Welcher UML-Diagrammtyp zeigt den in der Abbildung dargestellten Ablauf?', 1, 2, '{"topic":"uml","image":true}', 'Bild mit Antwort', 'assets/questions/leicht/L-B-3.png'
  WHERE NOT EXISTS (
    SELECT 1 FROM questions
    WHERE type = 'IMAGE'
...
WITH q AS (
  INSERT INTO questions (type, prompt, difficulty, points, meta, category, image_url)
  SELECT 'IMAGE', 'Welche UML-Diagrammart zeigt die in der Abbildung dargestellte Abfolge?', 1, 2, '{"topic":"uml","image":true}', 'Bild mit Antwort', 'assets/questions/leicht/L-B-4.png'
  WHERE NOT EXISTS (
    SELECT 1 FROM questions
    WHERE type = 'IMAGE'
...
WITH q AS (
  INSERT INTO questions (type, prompt, difficulty, points, meta, category, image_url)
  SELECT 'IMAGE', 'Welche Art von Beziehung zwischen den Klassen ist in der Abbildung dargestellt?', 1, 2, '{"topic":"uml","image":true}', 'Bild mit Antwort', 'assets/questions/leicht/L-B-5.png'
  WHERE NOT EXISTS (
    SELECT 1 FROM questions
    WHERE type = 'IMAGE'
...
WITH q AS (
  INSERT INTO questions (type, prompt, difficulty, points, meta, category, image_url)
  SELECT 'IMAGE', 'Welches UML-Diagramm stellt die in der Abbildung gezeigte Systemarchitektur dar?', 1, 2, '{"topic":"uml","image":true}', 'Bild mit Antwort', 'assets/questions/leicht/L-B-6.png'
  WHERE NOT EXISTS (
    SELECT 1 FROM questions
    WHERE type = 'IMAGE'
...
WITH q AS (
  INSERT INTO questions (type, prompt, difficulty, points, meta, category, image_url)
  SELECT 'IMAGE', 'Wie bezeichnet man die Strichmännchen in der vorliegenden UML-Diagrammart?', 1, 2, '{"topic":"uml","image":true}', 'Bild mit Antwort', 'assets/questions/leicht/L-B-7.png'
  WHERE NOT EXISTS (
    SELECT 1 FROM questions
    WHERE type = 'IMAGE'
...
WITH q AS (
  INSERT INTO questions (type, prompt, difficulty, points, meta, category, image_url)
  SELECT 'IMAGE', 'Welche UML-Diagrammart zeigt den in der Abbildung dargestellten Zyklus?', 1, 2, '{"topic":"uml","image":true}', 'Bild mit Antwort', 'assets/questions/leicht/L-B-8.png'
  WHERE NOT EXISTS (
    SELECT 1 FROM questions
    WHERE type = 'IMAGE'
...
-- ===========================================
-- BILDER FRAGEN Mittel (Bild 1 - 8)
-- ===========================================

-- M-B-1: Welche Beziehung zwischen den Klassen ist in der Abbildung dargestellt?
WITH q AS (
  INSERT INTO questions (type, prompt, difficulty, points, meta, category, image_url)
  SELECT 'IMAGE', 'Welche Beziehung zwischen den Klassen ist in der Abbildung dargestellt?', 2, 3, '{"topic":"uml","image":true}', 'Bild mit Antwort', 'assets/questions/mittel/M-B-1.png'
  WHERE NOT EXISTS (
    SELECT 1 FROM questions
    WHERE type = 'IMAGE'
...
WITH q AS (
  INSERT INTO questions (type, prompt, difficulty, points, meta, category, image_url)
  SELECT 'IMAGE', 'Welche UML-Diagrammart eignet sich am besten zur Darstellung des gezeigten Szenarios?', 2, 3, '{"topic":"uml","image":true}', 'Bild mit Antwort', 'assets/questions/mittel/M-B-2.png'
  WHERE NOT EXISTS (
    SELECT 1 FROM questions
    WHERE type = 'IMAGE'
...
WITH q AS (
  INSERT INTO questions (type, prompt, difficulty, points, meta, category, image_url)
  SELECT 'IMAGE', 'Welche Rolle übernimmt das in der Abbildung dargestellte Element im Diagramm?', 2, 3, '{"topic":"uml","image":true}', 'Bild mit Antwort', 'assets/questions/mittel/M-B-3.png'
  WHERE NOT EXISTS (
    SELECT 1 FROM questions
    WHERE type = 'IMAGE'
...
WITH q AS (
  INSERT INTO questions (type, prompt, difficulty, points, meta, category, image_url)
  SELECT 'IMAGE', 'Welche Aussage beschreibt den Ablauf im dargestellten Diagramm korrekt?', 2, 3, '{"topic":"uml","image":true}', 'Bild mit Antwort', 'assets/questions/mittel/M-B-4.png'
  WHERE NOT EXISTS (
    SELECT 1 FROM questions
    WHERE type = 'IMAGE'
...
WITH q AS (
  INSERT INTO questions (type, prompt, difficulty, points, meta, category, image_url)
  SELECT 'IMAGE', 'Welche UML-Diagrammart wird verwendet, um den dargestellten Zustandwechsel zu modellieren?', 2, 3, '{"topic":"uml","image":true}', 'Bild mit Antwort', 'assets/questions/mittel/M-B-5.png'
  WHERE NOT EXISTS (
    SELECT 1 FROM questions
    WHERE type = 'IMAGE'
...
WITH q AS (
  INSERT INTO questions (type, prompt, difficulty, points, meta, category, image_url)
  SELECT 'IMAGE', 'Welche Art von Beziehung besteht zwischen den dargestellten Klassen?', 2, 3, '{"topic":"uml","image":true}', 'Bild mit Antwort', 'assets/questions/mittel/M-B-6.png'
  WHERE NOT EXISTS (
    SELECT 1 FROM questions
    WHERE type = 'IMAGE'
...
WITH q AS (
  INSERT INTO questions (type, prompt, difficulty, points, meta, category, image_url)
  SELECT 'IMAGE', 'Welche Komponente ist in der Abbildung für die Ausführung der dargestellten Software verantwortlich?', 2, 3, '{"topic":"uml","image":true}', 'Bild mit Antwort', 'assets/questions/mittel/M-B-7.png'
  WHERE NOT EXISTS (
    SELECT 1 FROM questions
    WHERE type = 'IMAGE'
...
WITH q AS (
  INSERT INTO questions (type, prompt, difficulty, points, meta, category, image_url)
  SELECT 'IMAGE', 'Welche Information lässt sich aus der Abbildung direkt ablesen?', 2, 3, '{"topic":"uml","image":true}', 'Bild mit Antwort', 'assets/questions/mittel/M-B-8.png'
  WHERE NOT EXISTS (
    SELECT 1 FROM questions
    WHERE type = 'IMAGE'
...
WITH q AS (
  INSERT INTO questions (type, prompt, difficulty, points, meta, category, image_url)
  SELECT 'IMAGE', 'Welche konzeptionelle Aussage lässt sich aus dem dargestellten Diagramm korrekt ableiten?', 3, 5, '{"topic":"uml","image":true}', 'Bild mit Antwort', 'assets/questions/schwer/S-B-1.png'
  WHERE NOT EXISTS (
    SELECT 1 FROM questions
    WHERE type = 'IMAGE'
...
WITH q AS (
  INSERT INTO questions (type, prompt, difficulty, points, meta, category, image_url)
  SELECT 'IMAGE', 'Welche Eigenschaft der dargestellten Beziehung ist korrekt?', 3, 5, '{"topic":"uml","image":true}', 'Bild mit Antwort', 'assets/questions/schwer/S-B-2.png'
  WHERE NOT EXISTS (
    SELECT 1 FROM questions
    WHERE type = 'IMAGE'
...
WITH q AS (
  INSERT INTO questions (type, prompt, difficulty, points, meta, category, image_url)
  SELECT 'IMAGE', 'Welche Information wird durch das dargestellte Diagramm explizit modelliert?', 3, 5, '{"topic":"uml","image":true}', 'Bild mit Antwort', 'assets/questions/schwer/S-B-3.png'
  WHERE NOT EXISTS (
    SELECT 1 FROM questions
    WHERE type = 'IMAGE'
...
WITH q AS (
  INSERT INTO questions (type, prompt, difficulty, points, meta, category, image_url)
  SELECT 'IMAGE', 'Welche Schlussfolgerung lässt sich aus dem dargestellten Aktivitätsdiagramm ziehen?', 3, 5, '{"topic":"uml","image":true}', 'Bild mit Antwort', 'assets/questions/schwer/S-B-4.png'
  WHERE NOT EXISTS (
    SELECT 1 FROM questions
    WHERE type = 'IMAGE'
...
WITH q AS (
  INSERT INTO questions (type, prompt, difficulty, points, meta, category, image_url)
  SELECT 'IMAGE', 'Welche Aussage beschreibt den Zweck des dargestellten Diagramms am treffendsten?', 3, 5, '{"topic":"uml","image":true}', 'Bild mit Antwort', 'assets/questions/schwer/S-B-5.png'
  WHERE NOT EXISTS (
    SELECT 1 FROM questions
    WHERE type = 'IMAGE'
...
WITH q AS (
  INSERT INTO questions (type, prompt, difficulty, points, meta, category, image_url)
  SELECT 'IMAGE', 'Welche Information kann aus dem dargestellten Diagramm nicht direkt abgeleitet werden?', 3, 5, '{"topic":"uml","image":true}', 'Bild mit Antwort', 'assets/questions/schwer/S-B-6.png'
  WHERE NOT EXISTS (
    SELECT 1 FROM questions
    WHERE type = 'IMAGE'
...
WITH q AS (
  INSERT INTO questions (type, prompt, difficulty, points, meta, category, image_url)
  SELECT 'IMAGE', 'Welche UML-Diagrammart ist für die dargestellte Modellierung am besten geeignet?', 3, 5, '{"topic":"uml","image":true}', 'Bild mit Antwort', 'assets/questions/schwer/S-B-7.png'
  WHERE NOT EXISTS (
    SELECT 1 FROM questions
    WHERE type = 'IMAGE'
...
WITH q AS (
  INSERT INTO questions (type, prompt, difficulty, points, meta, category, image_url)
  SELECT 'IMAGE', 'Welche Modellierungsentscheidung wird im dargestellten Diagramm getroffen?', 3, 5, '{"topic":"uml","image":true}', 'Bild mit Antwort', 'assets/questions/schwer/S-B-8.png'
  WHERE NOT EXISTS (
    SELECT 1 FROM questions
    WHERE type = 'IMAGE'
...
-- ===========================================
-- Erweiterte Fragen (aus seeds_max.sql übernommen, kuratiert)
-- ===========================================

-- M-LT-1: Sequenzdiagramm – Lifeline
WITH q AS (
  INSERT INTO questions (type, prompt, difficulty, points, meta, category)
  SELECT 'CLOZE', 'In einem Sequenzdiagramm repräsentiert die gestrichelte Linie unter einem Objekt die sogenannte ___.', 2, 3, '{"topic":"uml","class":"Sequenzdiagramm"}', 'Lückentext'
  WHERE NOT EXISTS (
    SELECT 1 FROM questions
    WHERE type = 'CLOZE'
...
INSERT INTO cloze_answers (question_id, token_index, expected_text, partial_value)
SELECT q_id.id, 1, 'Lifeline', 1.0
FROM q_id
ON CONFLICT (question_id, token_index) DO NOTHING;

-- M-LT-2: Use-Case – funktionale Anforderungen / Akteure
WITH q AS (
  INSERT INTO questions (type, prompt, difficulty, points, meta, category)
  SELECT 'CLOZE', 'Ein Use-Case-Diagramm beschreibt die ___ Anforderungen eines Systems aus der Sicht der ___.', 2, 3, '{"topic":"uml","class":"Use-Case"}', 'Lückentext'
  WHERE NOT EXISTS (
    SELECT 1 FROM questions
    WHERE type = 'CLOZE'
...
-- M-LT-3: Klassendiagramm – Vererbung (offenes Dreieck)
WITH q AS (
  INSERT INTO questions (type, prompt, difficulty, points, meta, category)
  SELECT 'CLOZE', 'In einem Klassendiagramm wird die Vererbung durch eine Linie mit einem ___ ___ dargestellt.', 2, 3, '{"topic":"uml","class":"Klassendiagramm"}', 'Lückentext'
  WHERE NOT EXISTS (
    SELECT 1 FROM questions
    WHERE type = 'CLOZE'
...
-- M-LT-4: Sequenzdiagramm – zeitliche Achse
WITH q AS (
  INSERT INTO questions (type, prompt, difficulty, points, meta, category)
  SELECT 'CLOZE', 'Ein Sequenzdiagramm stellt die Interaktionen zwischen Objekten entlang einer ___ ___ dar.', 2, 3, '{"topic":"uml","class":"Sequenzdiagramm"}', 'Lückentext'
  WHERE NOT EXISTS (
    SELECT 1 FROM questions
    WHERE type = 'CLOZE'
...
-- M-LT-5: Aktivitätsdiagramm – Forks
WITH q AS (
  INSERT INTO questions (type, prompt, difficulty, points, meta, category)
  SELECT 'CLOZE', 'Ein Aktivitätsdiagramm kann mithilfe von ___ die Aufteilung in parallele Abläufe darstellen.', 2, 3, '{"topic":"uml","class":"Aktivitätsdiagramm"}', 'Lückentext'
  WHERE NOT EXISTS (
    SELECT 1 FROM questions
    WHERE type = 'CLOZE'
...
-- M-LT-6: Deployment – Softwareartefakte zu Hardwareknoten
WITH q AS (
  INSERT INTO questions (type, prompt, difficulty, points, meta, category)
  SELECT 'CLOZE', 'Ein Deployment-Diagramm zeigt die Zuordnung von ___ zu ___.', 2, 3, '{"topic":"uml","class":"Deployment"}', 'Lückentext'
  WHERE NOT EXISTS (
    SELECT 1 FROM questions
    WHERE type = 'CLOZE'
...
-- M-LT-7: Aggregation – Ganzes/Teil
WITH q AS (
  INSERT INTO questions (type, prompt, difficulty, points, meta, category)
  SELECT 'CLOZE', 'Eine Aggregation beschreibt eine ___-___-Beziehung zwischen Klassen.', 2, 3, '{"topic":"uml","class":"Klassendiagramm"}', 'Lückentext'
  WHERE NOT EXISTS (
    SELECT 1 FROM questions
    WHERE type = 'CLOZE'
...
-- M-LT-8: Zustandsdiagramm – Übergänge
WITH q AS (
  INSERT INTO questions (type, prompt, difficulty, points, meta, category)
  SELECT 'CLOZE', 'Zustandsdiagramme bestehen aus Zuständen und ___, die den Wechsel zwischen diesen beschreiben.', 2, 3, '{"topic":"uml","class":"Zustandsdiagramm"}', 'Lückentext'
  WHERE NOT EXISTS (
    SELECT 1 FROM questions
    WHERE type = 'CLOZE'
...
-- ===========================================
-- Encoding-Fix: fehlerhafte Sonderzeichen bereinigen
-- ===========================================
UPDATE questions
SET prompt = REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(prompt,
  'ÃƒÂ¤', 'ä'), 'ÃƒÂ¶', 'ö'), 'ÃƒÂ¼', 'ü'), 'ÃƒÂŸ', 'ß'), 'ÃƒÂ„', 'Ä'), 'ÃƒÂ–', 'Ö'), 'ÃƒÂœ', 'Ü')
WHERE prompt LIKE '%Ã%';
...
UPDATE questions
SET category = REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(category,
  'ÃƒÂ¤', 'ä'), 'ÃƒÂ¶', 'ö'), 'ÃƒÂ¼', 'ü'), 'ÃƒÂŸ', 'ß'), 'ÃƒÂ„', 'Ä'), 'ÃƒÂ–', 'Ö'), 'ÃƒÂœ', 'Ü')
...
UPDATE answers
SET answer_text = REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(answer_text,
  'ÃƒÂ¤', 'ä'), 'ÃƒÂ¶', 'ö'), 'ÃƒÂ¼', 'ü'), 'ÃƒÂŸ', 'ß'), 'ÃƒÂ„', 'Ä'), 'ÃƒÂ–', 'Ö'), 'ÃƒÂœ', 'Ü')
WHERE answer_text LIKE '%Ã%';
...
UPDATE cloze_answers
SET expected_text = REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(expected_text,
  'ÃƒÂ¤', 'ä'), 'ÃƒÂ¶', 'ö'), 'ÃƒÂ¼', 'ü'), 'ÃƒÂŸ', 'ß'), 'ÃƒÂ„', 'Ä'), 'ÃƒÂ–', 'Ö'), 'ÃƒÂœ', 'Ü')
WHERE expected_text LIKE '%Ã%';
...
-- Deduplicate answers after normalization
